...
where the first element is the product of those numbers, and the second element is a string
...
and to do multiplication, use your multiply() function that you've already created. You're going to have to be resourceful to figure out how to do this. However, you may continue to use the + operator for string concatenation.
Test this function by hand in the console to get it working, and when you think it is finished, 
...
function sumAndMultiply(a,b,c) { //eslint-disable-line
    ...
    var multi2 = multiply(multi1[0],c);
    var message1 = a + " and " + b + " and "+ c +" sum to "+ sum2[0] + ".";
    var message2 = "The product of " + a + " and " + b + " and " + c + " is "  + multi2[0] +".";
    return [sum2[0], multi2[0],message1 ,message2];
}
...
where the first element is the sum of the numbers in the array, and the second element is a string that 
...
function sumArray(sumArr) { //eslint-disable-line
    ...
    var message = sumArr[0] + "," + sumArr[1] + "," + sumArr[2] + " was passed in as an array of numbers, and " + sum2[0] + " is their sum.";
    return [sum2[0],message];
}
...
when you think it is finished, uncomment the call for the testMultiplyArray() function and see if the test passes.*/

// Write your code here
function multiplyArray(multArr) { //eslint-disable-line
    var multi1 = multiply(multArr[0],multArr[1]);
    var multi2 = multiply(multi1[0],multArr[2]);
    var message = "The numbers " + multArr[0] + "," + multArr[1] + "," + multArr[2] + " have a product of " + multi2[0] + ".";
    return [multi2[0],message];
}
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
    ...
    for(var i=0 ; i < dynamicArray.length; i++){
        var sec = multiply(dynamicArray[i], multi);
        multi = sec[0];
    }

    var message = "The numbers " + dynamicArray + " have a product of " + multi + ".";
